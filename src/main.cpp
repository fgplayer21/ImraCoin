...
uint256 hashGenesisBlock("0xc6a7e3ed66c4a6827cd355838136625027f9d212d0b3208813e08a17bbfa1788");
static CBigNum bnProofOfWorkLimit = CBigNum().SetCompact(504365644); // ImraCoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "ImraCoin Signed Message:\n";
...
{
    // ImraCoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 120000); // ImraCoin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 3000; // ImraCoin: 3.5 days
static const int64 nTargetSpacing = 300; // ImraCoin: 2.5 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // ImraCoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // ImraCoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // ImraCoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xdfbb28807b7d0ab4bc220df155f65be30b67e2c06c808a910ccc0faba875d1f9");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "[26.06.2017] Imre Liiv has its own coin!";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 10000000000;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("72abb213bbbac901817a19c9d83fba5b58a2799c6da98de5fd1c7ecb4c11f951c6c389774d7163db742c72e9d2311fd969844f9590dc270e7d2805da41c819384a") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1498384833;
        block.nBits    = 504365644;
        block.nNonce   = 3883222488;

        if (fTestNet)
        {
            block.nTime    = 1498384833;
            block.nNonce   = 1447611598;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x23777fec66cef3a55c986e40b076e8f3a4d1f282d9e9847d933516683e1e32d4"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // ImraCoin: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("ImraCoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("ImraCoinMiner : ProcessBlock, block not accepted");
    }
